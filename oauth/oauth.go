...
"encoding/json"
"fmt"
"github.com/maik101010/oauthCourseGoLibrary/oauth/errors"
...
func getAccessToken(accessTokenId string)  (*accessToken, *errors.RestError)  {
	...
	if response.StatusCode>299 {
		...
		if err!=nil {
			return nil, errors.NewInternalServerError("invalid error interface when trying to get access_tolken")
		}
		return nil, &restErr
	}
	var at accessToken
	if err := json.Unmarshal(response.Bytes(), &at); err!=nil  {
		return nil, errors.NewInternalServerError("error when trying on marschall access_tolken response")
	}
	return &at, nil
}
